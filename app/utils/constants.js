...
export default {
  ...
  FETCH_CATEGORY_SUCCESSFUL: 'Fetched all categories successfully',
  ...
  PIN_UPDATE_SUCCESS: 'Tx Pin updated successfully',
  CREATE_PIN_ERROR: 'CREATE_PIN_ERROR',
  CREATE_PIN_ERROR_MSG: 'Error while updating PIN',
  USER_PIN_VALIDATION_ERROR: 'USER_PIN_VALIDATION_ERROR',
  INVALID_PIN: 'Incorrect pin',
  USER_PIN_VALIDATION_ERROR_MSG: 'Error while trying to verify PIN',
  TX_VALIDATION_ERROR: 'TX_VALIDATION_ERROR',
  NO_WALLET: 'No wallet yet',
  WALLET_VALIDATION_ERROR: 'WALLET_VALIDATION_ERROR',
